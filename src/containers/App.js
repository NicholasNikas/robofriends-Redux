...
// import {robots} from './robots'; // Dont need this anymore!
...
class App extends Component {
    ...
    onSearchChange = (event) => { // important to always use arrow functions for helper methods
    ...
    render() {
        ...
        if (!robots.length){ // if length is 0
            ...
            return (
                <div className='tc'>
                    ...
                    <Scroll>
                         <CardList robots={filteredRobots}/>  {/* output the filtered roboits instead of all robots */}
                    </Scroll>
                </div>
            );
        }
